...
import { updatePairDayData, updateTokenDayData, updateNomiswapDayData, updatePairHourData } from "./dayUpdates";
...
export function handleSync(event: Sync): void {
  ...
  Nomiswap.totalLiquidityBNB = Nomiswap.totalLiquidityBNB.minus(pair.trackedReserveBNB as BigDecimal);
  ...
  Nomiswap.totalLiquidityBNB = Nomiswap.totalLiquidityBNB.plus(trackedLiquidityBNB);
  Nomiswap.totalLiquidityUSD = Nomiswap.totalLiquidityBNB.times(bundle.bnbPrice);
...
export function handleSwap(event: Swap): void {
  ...
  Nomiswap.totalVolumeBNB = Nomiswap.totalVolumeBNB.plus(trackedAmountBNB);
  Nomiswap.untrackedVolumeUSD = Nomiswap.untrackedVolumeUSD.plus(derivedAmountUSD);
  Nomiswap.totalTransactions = Nomiswap.totalTransactions.plus(ONE_BI);
  ...
  NomiswapDayData.dailyVolumeBNB = NomiswapDayData.dailyVolumeBNB.plus(trackedAmountBNB);
  NomiswapDayData.dailyVolumeUntracked = NomiswapDayData.dailyVolumeUntracked.plus(derivedAmountUSD);
